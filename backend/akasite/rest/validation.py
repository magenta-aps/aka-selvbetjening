...
class __Result():
    ...
    **warning**: DO NOT USE DIRECTLY, THIS IS AN ABSTRACT CLASS
    ...
    def andThen(self, f):
        ...
        Eg: getting the first element of a list, andThen validating that element,
            the validation of the element cannot occur, if it was an empty list,
            as there would be no element.
