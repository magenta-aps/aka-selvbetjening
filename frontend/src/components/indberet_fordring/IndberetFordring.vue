    ...
    <article class="indberet_fordring">
        ...
        <form @submit.prevent="sendFormRequest()">
            ...
            <fieldset>
                ...
                <input id="tb_barns_cpr" type="text" :class="{submitted: isSubmitted}" v-model="barns_cpr" minlength="10" maxlength="10">
        ...
        methods: {
            ...
            fetchFormData: function() {
                ...
                function appendData(string) {
                    if (that[string] !== null){
                        if (string === 'fordringsgruppe' ||
                            string === 'fordringstype') {
