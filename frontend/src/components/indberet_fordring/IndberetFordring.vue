    ...
    <article class="indberet_fordring">
        ...
        <form @submit.prevent="sendFormRequest()">
            ...
            <fieldset>
                ...
                <input id="fordringshaver" type="text" v-model="fordringshaver" required>

                <label id="lbl_debitor" for="debitor">{{ $t("debitor") }}</label>
                <input id="debitor" type="text" v-model="debitor" required>
            ...
            <fieldset>
                ...
                <input id="tb_ekstern_sagsnummer" type="text" v-model="ekstern_sagsnummer" required>

                <label id="lbl_fakturanr" for="tb_fakturanr">{{ $t("fakturanr") }}</label>
                <input id="tb_fakturanr" type="text" v-model="fakturanr" required>
            ...
            <fieldset> <!--TODO: Fix wrapping -->
                ...
                <input id="tb_hovedstol" type="text" v-model="hovedstol" required>
                <label id="lbl_hovedstol_posteringstekst" for="tb_hovedstol_posteringstekst">{{ $t("posteringstekst") }}</label>
                <input id="tb_hovedstol_posteringstekst" type="text" v-model="hovedstol_posteringstekst" required>
            ...
            <fieldset> <!--TODO: Fix wrapping -->
                ...
                <input id="tb_forfaldsdato" type="date" v-model="forfaldsdato" required>

                <label id="lbl_betalingsdato" for="tb_betalingsdato">{{ $t("betalinsgdato") }}</label>
                <input id="tb_betalingsdato" type="date" v-model="betalingsdato" required>

                <label id="lbl_foraeldelsesdato" for="tb_foraeldelsesdato">{{ $t("forældelsesdato") }}</label>
                <input id="tb_foraeldelsesdato" type="date" v-model="foraeldelsesdato" required>
            </fieldset>
...
<script>
    ...
    // The file fordringsgruppe.js below is generated by `make fronten`
