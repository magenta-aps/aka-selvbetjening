...
export const messages = {
  da: {
    ...
    rentenota: {
      ...
      dato: 'Dato',
      postdato: 'Postdato',
      debitorkonto: 'Debitor&#173;konto',
      faktureringsklassifikation: 'Fakturerings&#173;klassifikation',
      rentenotanummer: 'Rentenota&#173;nummer',
      bilag: 'Bilag',
      faktura: 'Faktura',
      tekst: 'Tekst',
      fradato: 'Fradato',
  ...
  kl: {
    ...
    rentenota: {
      ...
      debitorkonto: 'Debitor&#173;konto - oversættelse mangler',
      faktureringsklassifikation: 'Fakturerings&#173;klassifikation - oversættelse mangler',
      rentenotanummer: 'Rentenota&#173;nummer - oversættelse mangler',
      ...
      tildato: 'Tildato - oversættelse mangler',
      dage: 'Dage - oversættelse mangler',
      grundlag: 'Grundlag - oversættelse mangler',
      forfald: 'Forfalds&#173;dato - oversættelse mangler',
    ...
    inkasso: {
      ...
      slet: 'Nunguteruk',
      template: 'Download skabelon - oversættelse mangler',
