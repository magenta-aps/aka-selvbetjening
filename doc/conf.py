...
import os
import sys
sys.path.insert(0, os.path.abspath('../backend/akasite/helpers'))
...
htmlhelp_basename = 'DjangoTemplatedoc'
...
latex_documents = [
    (master_doc, 'DjangoTemplate.tex', 'DjangoTemplate Documentation',
     'Magenta ApS', 'manual'),
]
...
man_pages = [
    (master_doc, 'djangotemplate', 'DjangoTemplate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DjangoTemplate', 'DjangoTemplate Documentation',
     author, 'DjangoTemplate', 'One line description of project.',
     'Miscellaneous'),
]
